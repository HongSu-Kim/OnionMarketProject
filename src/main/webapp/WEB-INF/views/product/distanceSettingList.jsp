	...
	<%@ page import="com.youprice.onion.dto.product.ProductRangeDTO" %>
	...
	<div>
		...
		<c:if test="${!empty rangeProduct }">
			...
			<%
				...
				ArrayList<Object> list = (ArrayList) request.getAttribute("rangeProduct");
				ArrayList<Object> list2 = (ArrayList) request.getAttribute("rangeProduct2");

//					ArrayList<Object> list2 = (ArrayList) session.getAttribute("rangeProduct2");
				int sum =0;
				for(int i=0; i<list.size(); i++) {
					...
					if (i % 3 == 0) {
						out.println("<img src=/img/product/" + list2.get(i) + "> " + " </img>" + "<br/>");
