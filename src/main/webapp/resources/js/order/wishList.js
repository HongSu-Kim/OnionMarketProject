...
$(function () {
	$('.chatroomBtn').click(function () {
		let chatroomBtn = $(this)
		createChatroom(chatroomBtn.siblings('#productId').val())

		if (!chatroomBtn.hasClass("true")) {
			chatroomBtn.addClass("true")
			chatroomBtn.siblings('#chatroomListSize').html(parseInt(chatroomBtn.siblings('#chatroomListSize').html()) + 1)
		}
	})
})
