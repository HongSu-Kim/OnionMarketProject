...
public interface InquiryService {
    ...
    Page<InquiryDTO> getPeriodSearch(String dt_fr, String dt_to, String status, Long memberId, Pageable pageable);
    Page<InquiryDTO> listByStatus(String status, Long memberId, Pageable pageable);
