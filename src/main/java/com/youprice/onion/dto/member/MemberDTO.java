...
public class MemberDTO {
    ...
    @Builder
    public MemberDTO(Role role, String userId, String pwd, String name, String nickname, LocalDate birth, String tel, String postcode, String address, String detailAddress, String extraAddress, String email, String memberImageName) {
        ...
        this.birth = birth;
        this.tel = tel;
        this.address = String.valueOf(new Address(postcode, address, detailAddress, extraAddress));
        this.email = email;
